                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <div className="flex flex-wrap items-center gap-1">
                        ...
                        {!p.active && (
                          <span className={cn('inline-flex items-center rounded-md border border-[var(--color-fg-subtle)]/15 bg-[var(--color-bg-subtle)] px-2 py-0.5 font-medium text-[10px] text-[var(--color-fg-muted)] uppercase tracking-wide')}>
                            Inactiva
                          </span>
                        )}
                      </div>
